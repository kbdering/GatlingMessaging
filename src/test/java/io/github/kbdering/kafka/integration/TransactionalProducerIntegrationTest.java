...
public class TransactionalProducerIntegrationTest {
    ...
    public void testTransactionalSend() throws Exception {
        ...
        KafkaRequestReplyActionBuilder actionBuilder = KafkaDsl.kafkaRequestReply(
                ...
                s -> "key", s -> "value",
                io.github.kbdering.kafka.util.SerializationType.STRING,
        ...
        io.github.kbdering.kafka.actors.KafkaProducerActor.ProduceMessage message = new io.github.kbdering.kafka.actors.KafkaProducerActor.ProduceMessage(
