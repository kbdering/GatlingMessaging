...
public class AvroIdlIntegrationTest {

    private static final String TOPIC = "avro-idl-topic";
    ...
    @Test
    public void testAvroIdlLoading() {
        // Run Gatling Simulation
        String[] args = new String[] {
                "-s", AvroIdlSimulation.class.getName(),
                "-rf", "target/gatling",
    ...
    private void verifyMessages() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "verify-idl-group");
        ...
        try (KafkaConsumer<String, GenericRecord> consumer = new KafkaConsumer<>(props)) {
            ...
            assertTrue("Should have received messages with IDL-based schema", records.count() > 0);
            System.out.println("Verified " + records.count() + " Avro messages (from IDL) in topic " + TOPIC);
        }
    }
}
