...
public class UninitializedAvroIntegrationTest {

    private static final String TOPIC = "uninitialized-avro-topic";
    ...
    @Test
    public void testUninitializedAvro() {
        String[] args = new String[] {
                "-s", UninitializedAvroSimulation.class.getName(),
                "-rf", "target/gatling",
