...
public class AvroFireAndForgetIntegrationTest {

    private static final String TOPIC = "avro-fire-forget-topic";
    ...
    @Test
    public void testAvroFireAndForget() {
        // 1. Run Gatling Simulation
        String[] args = new String[] {
                "-s", AvroFireAndForgetSimulation.class.getName(),
                "-rf", "target/gatling",
    ...
    private void verifyMessages() {
        ...
        try (KafkaConsumer<String, GenericRecord> consumer = new KafkaConsumer<>(props)) {
            ...
            assertTrue("Should have received at least some messages", records.count() > 0);
            System.out.println("Verified " + records.count() + " Avro messages in topic " + TOPIC);
        }
    }
}
